...
/**
 * Convert from BigInteger to Integer
 *
 * @author aafanasyev
 */
@Converter
public class CopyConverterBigInt2Int implements CopyConverter {
    ...
    public ConverterKey[] listConvertedPairs() {
        return new ConverterKey[] {new ConverterKey(BigInteger.class, Integer.class)};
    }
}
