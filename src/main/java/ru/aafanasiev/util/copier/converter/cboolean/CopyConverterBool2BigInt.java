 ...
 */
@Converter
public class CopyConverterBool2BigInt implements CopyConverter {
    private static final BigInteger TRUE_VALUE = BigInteger.valueOf(1);
    private static final BigInteger FALSE_VALUE = BigInteger.valueOf(0);
    ...
    public ConverterKey[] listConvertedPairs() {
        return new ConverterKey[] {new ConverterKey(Boolean.class, BigInteger.class)};
    }
}
