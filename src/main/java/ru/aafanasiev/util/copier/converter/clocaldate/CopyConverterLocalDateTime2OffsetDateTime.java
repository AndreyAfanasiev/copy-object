 ...
 */
@Converter
public class CopyConverterLocalDateTime2OffsetDateTime implements CopyConverter {
    ...
    public ConverterKey[] listConvertedPairs() {
        return new ConverterKey[] {new ConverterKey(LocalDateTime.class, OffsetDateTime.class)};
    }
