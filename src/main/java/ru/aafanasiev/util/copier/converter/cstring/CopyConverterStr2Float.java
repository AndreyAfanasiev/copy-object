 ...
 */
@Converter
public class CopyConverterStr2Float implements CopyConverter {
    ...
    public ConverterKey[] listConvertedPairs() {
        return new ConverterKey[] {new ConverterKey(String.class, Float.class)};
    }
}
