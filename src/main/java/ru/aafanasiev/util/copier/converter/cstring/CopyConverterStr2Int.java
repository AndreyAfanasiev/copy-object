 ...
 */
@Converter
public class CopyConverterStr2Int implements CopyConverter {
    ...
    public ConverterKey[] listConvertedPairs() {
        return new ConverterKey[] {new ConverterKey(String.class, Integer.class)};
    }
}
