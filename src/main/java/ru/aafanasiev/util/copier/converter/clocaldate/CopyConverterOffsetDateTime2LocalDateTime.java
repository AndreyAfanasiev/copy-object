 ...
 */
@Converter
public class CopyConverterOffsetDateTime2LocalDateTime implements CopyConverter {
    ...
    public ConverterKey[] listConvertedPairs() {
        return new ConverterKey[] {new ConverterKey(OffsetDateTime.class, LocalDateTime.class)};
    }
