 ...
 */
@Converter
public class CopyConverterOffsetDateTime2OffsetTime implements CopyConverter {
    ...
    public ConverterKey[] listConvertedPairs() {
        return new ConverterKey[] {new ConverterKey(OffsetDateTime.class, OffsetTime.class)};
    }
