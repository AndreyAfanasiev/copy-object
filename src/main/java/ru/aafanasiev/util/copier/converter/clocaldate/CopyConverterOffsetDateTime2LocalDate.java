 ...
 */
@Converter
public class CopyConverterOffsetDateTime2LocalDate implements CopyConverter {
    ...
    public ConverterKey[] listConvertedPairs() {
        return new ConverterKey[] {new ConverterKey(OffsetDateTime.class, LocalDate.class)};
    }
