 ...
 * @author aafanasyev
 */
@Test(groups = {"CopyConverterOffsetDateTime2OffsetTimeTest", "UTIL"}, ignoreMissingDependencies = true)
public class CopyConverterOffsetDateTime2OffsetTimeTest extends CopyConverterLocalDateBase {
    @BeforeMethod
    public void intitialize() {
        convertor = new CopyConverterOffsetDateTime2OffsetTime();
        entry = new CopyEntry();
    }
    ...
    public void testConvert() throws Exception {
        ...
        assertEquals(res, now.toOffsetTime());
    }
