 ...
 * @author aafanasyev
 */
@Test(groups = {"CopyConverterOffsetDateTime2LocalTimeTest", "UTIL"}, ignoreMissingDependencies = true)
public class CopyConverterOffsetDateTime2LocalTimeTest extends CopyConverterLocalDateBase {
    @BeforeMethod
    public void intitialize() {
        convertor = new CopyConverterOffsetDateTime2LocalTime();
        init();
    }
