...
public class CopyConverterUDate2SDateTest {
    ...
    public void testConvert() throws Exception {
        ...
        Date dt = new Date(10);
        java.sql.Date dt1 = new java.sql.Date(10);

        java.sql.Date res = (java.sql.Date) convertor.convert(entry, dt);
    ...
    public void testListConvertedPairs() throws Exception {
        ...
        assertEquals(array[0].getToClazz(), java.sql.Date.class);
    }
