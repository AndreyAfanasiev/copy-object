 ...
 * @author aafanasyev
 */
@Test(groups = {"CopyConverterUDate2LocalTimeTest", "UTIL"}, ignoreMissingDependencies = true)
public class CopyConverterUDate2LocalTimeTest extends CopyConverterLocalDateBase {
    @BeforeMethod
    public void intitialize() {
        convertor = new CopyConverterUDate2LocalTime();
        entry = new CopyEntry();
    }
    ...
    public void testConvert() throws Exception {
        ...
        assertEquals(res, now.toInstant().atZone(ZoneId.systemDefault()).toLocalTime());
    }
