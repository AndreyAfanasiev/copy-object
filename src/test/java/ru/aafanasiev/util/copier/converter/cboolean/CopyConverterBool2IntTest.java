...
public class CopyConverterBool2IntTest extends CopyConverterDoubleBase {
    @BeforeMethod
    public void intitialize() {
        convertor = new CopyConverterBool2Int();
        init();
    }
    ...
    public void testConvert() throws Exception {
        Integer result = (Integer) convertor.convert(entry, Boolean.FALSE);
        assertEquals(result.intValue(), 0);

        result = (Integer) convertor.convert(entry, Boolean.TRUE);
